...
class OutgoingPackageCreator
{
    ...
    public function connect($host, $login = null, $passcode = null)
    {
        ...
        $headers = ['accept-version' => '1.1', 'host' => $host];
    ...
    public function subscribe($destination, $ack = 'auto', array $headers = [])
    {
    ...
    public function begin($transactionId, array $headers = [])
    {
    ...
    public function commit($transactionId, array $headers = [])
    {
        $headers['transaction'] = $transactionId;
    ...
    public function abort($transactionId, array $headers = [])
    {
        $headers['transaction'] = $transactionId;
    ...
    public function disconnect($receipt, array $headers = [])
    {
